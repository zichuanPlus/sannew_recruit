...
<head><!DOCTYPE HTML>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('HUI/lib/Hui-iconfont/1.0.8/iconfont.min.css')}}" />
        <!--[if lt IE 9]>
        <link href="{{asset('HUI/static/h-ui/css/H-ui.ie.css')}}" rel="stylesheet" type="text/css" />
        <![endif]-->
        <!--[if IE 6]>
